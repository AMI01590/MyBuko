...
import { 
  Eye, EyeOff, AlertCircle, Target, User, Mail, Lock, CheckCircle, 
  Star, MapPin, Award, ArrowRight, Sparkles, Compass, Check 
} from 'lucide-react'
...
export default function SignupPage() {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Update real-time validation checks
    if (name === 'name') {
      setValidationStates(prev => ({ ...prev, nameValid: value.trim().length >= 2 }))
    } else if (name === 'email') {
      setValidationStates(prev => ({ ...prev, emailValid: validateEmail(value) }))
    } else if (name === 'password') {
      setValidationStates(prev => ({ ...prev, passwordValid: value.length >= 6 }))
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen w-full relative z-20">
        ...
        <div className="hidden lg:flex flex-col justify-between p-16 relative overflow-hidden border-r border-white/5 bg-[#030712]/30 backdrop-blur-md">
          ...
          <div className="flex items-center gap-3.5">
            ...
            <p className="text-xs font-semibold text-slate-455 tracking-wide">
        ...
        <div className="flex flex-col items-center justify-center p-6 sm:p-12 relative z-20">
          ...
          >
            ...
            <div className="text-center mb-8">
              <h1 className="text-3xl font-extrabold tracking-tight bg-gradient-to-r from-white via-slate-100 to-slate-355 bg-clip-text text-transparent font-display mb-2">
                Create Account
              </h1>
              <p className="text-sm text-slate-400">
                Join now and build your visual life itinerary map.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4.5 relative z-10">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  />
                  {/* Name Valid Checkmark */}
                  <AnimatePresence>
                    {validationStates.nameValid && (
                      <motion.span
              ...
              >
                {isLoading ? (
                  ...
                  <>
                    <span>Create My Dream Portfolio</span>
